Attribute VB_Name = "test_neyman_gof"
'Created by Peter Stikker
'Companion website: https://PeterStatistics.com
'YouTube channel: https://www.youtube.com/stikpet
'Donations welcome at Patreon: https://www.patreon.com/bePatron?u=19398076

Function ts_neyman_gof(data As Range, Optional expCount As Range, Optional cc = "none", Optional output = "all")
Attribute ts_neyman_gof.VB_Description = "Neyman goodness-of-fit test"
Attribute ts_neyman_gof.VB_ProcData.VB_Invoke_Func = " \n14"
...
Else
    ...
    For i = 1 To k
        If cats(i, 2) <> 0 Then
            ...
            chiVal = chiVal + (cats(i, 2) - expCounts(i)) ^ 2 / cats(i, 2)
